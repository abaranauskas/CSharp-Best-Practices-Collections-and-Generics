...
namespace Acme.Biz
{
    ...
    public class Vendor
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            Vendor compareVendors = obj as Vendor;

            if (compareVendors!=null && this.VendorId==compareVendors.VendorId
                && this.CompanyName==compareVendors.CompanyName
                && this.Email==compareVendors.Email)
            {
                return true;
            }
